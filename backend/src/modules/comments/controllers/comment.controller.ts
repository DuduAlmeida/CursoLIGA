...
export class CommentController {
    ...
    @ApiQuery({ name: 'includeCategory', required: false, example: true, allowEmptyValue: false, description: 'Diz se deve incluir as indormações da categoria do comentário' })
    ...
    public getMany(
        ...
        return this.service.listMany(categoryId, page, maxItens,includeCategory);
    }
